 ...
 * Este algoritmo sólo soporta letras mayúsculas. Soporta la letra 'Ñ', este es
 * manejado con su valor ASCII el cual es 165 o Unicode 209
 * 
...
public class Vigenere {
	 ...
	 * así como la clave a utilizarjunto con los arrelgos, se obtiene sus longitudes
	 * y se crean las dos arreglos donde se guardarán los valores de cada letra.
	 */
	...
	/*
	 * Función encargada de desencriptar la cadena encriptada, recibe los parametros
	 * de la CADENA así como la clave a utilizar junto con los arrelgos, se obtiene
	 * sus longitudes y se crean las dos arreglos donde se guardarán los valores de
	 * cada letra.
	 */
