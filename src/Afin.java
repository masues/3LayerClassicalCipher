...
public class Afin {
   ...
   * @param englishAlphabet Bandera que indica si se usa el alfabeto inglés. Si se
   *                        usa el alfabeto castellano la bandera tendrá el valor
   *                        false.
   */
  ...
  /**
   * Método para mapear entre caracteres del alfabeto y su correspondiente número
   * El alfabeto inglés va de A = 65 hasta Z = 90. Estos números son normalizados
   * a A = 0 hasta Z = 25. Para el alfabeto castellano se añade la letra Ñ, al
   * cual le corresponde Ñ = 209, pero es transformado a Ñ = 15, posteriormente O
   ...
   * 
   * @param numericRep Valor numérico para transformar a su representación en
   *                   carácter.
  ...
  /**
   * Este método tiene como entrada al mensaje en claro y como salida devuelve al
   * mensaje cifrado mediante el algoritmo afín.
   * 
  ...
  /**
   * Este método tiene como entrada una cadena cifrada mediante el algoritmo afín
   * y devuelve la cadena descifrada.
   * 
